...
**IDE tools (22):** list_project_items, get_current_location, select_project_item,
...
revert_project, save_project, get_item_description, constant_value, property_value,
set_declaration, analyze_project, debug_control
